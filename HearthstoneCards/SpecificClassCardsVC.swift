//
//  SpecificClassCardsVC.swift
//  HearthstoneCards
//
//  Created by Jeremiah Bonham on 2/26/16.
...
class SpecificClassCardsVC: UITableViewController{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print(classSelected)
        //classSelected = MainViewController().thisSelectedClass
        self.getCardData()
    ...
    func getCardData(){
        ...
        let requestURL: NSURL = NSURL(string: "https://raw.githubusercontent.com/J-Bonham/hearthstone-db/master/cards/all-cards.updated1.json")!
            ...
            if (statusCode == 200) {
                ...
                do {
                    ...
                    for var i = 0; i<json2?!.count; ++i {
                        ...
                        if (dictResult.objectForKey("hero") as! String == self.classSelected) {
